...
CREATE INDEX IF NOT EXISTS idx_team_injury_reports_team_date ON team_injury_reports(team_abbreviation, report_date);
CREATE INDEX IF NOT EXISTS idx_team_context_summaries_team_date ON team_context_summaries(team_id, summary_date);
